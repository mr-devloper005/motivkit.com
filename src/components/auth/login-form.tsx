...
export function LoginForm() {
  ...
  return (
    <div className="rounded-[2rem] border border-[rgba(133,25,60,0.22)] bg-white/85 p-8 shadow-[0_12px_40px_-20px_rgba(74,16,42,0.35)] backdrop-blur-sm">
      <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#85193C]/85">Welcome back</p>
      <p className="mt-2 text-sm text-[#85193C]/80">Sign in with the email and password you used to register — stored only on this device.</p>
      ...
      <div className="mt-6 flex flex-wrap items-center justify-between gap-3 text-sm text-[#85193C]/90">
        <Link href="/forgot-password" className="hover:text-[#C5172E] hover:underline">
          Forgot password?
        </Link>
        <Link href="/register" className="inline-flex items-center gap-2 font-semibold text-[#4A102A] hover:text-[#C5172E]">
