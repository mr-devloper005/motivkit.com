export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'motivkit',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'MotivKit',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'motivkit.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://motivkit.com',
